This repository contains automation scripts written in **JavaScript** using **Playwright** for web application testing. It also demonstrates integrating automation tests with **GitHub Actions** and **Jenkins**.
